...
vector<int> SquareMaze::solveMaze()
{
	...
	vector<int> solution;
	vector<bool> hasVisited(size,false); //vector with visited cells
	vector<int> distances(size,0); //vector with distances to each valid cell
	vector<int> predecessors(size,-1); //vector that holds the cell before the next cell's path
